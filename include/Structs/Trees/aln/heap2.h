...
template <class Key, class Value>
inline void Heap2<Key, Value>::clear()
{
  size = 0;
}
...
template <class Key, class Value>
inline void Heap2<Key, Value>::reserve(std::size_t)
{
   ;
}

template <class Key, class Value>
inline bool Heap2<Key, Value>::empty() const
{
   return ( size == 0);
}
...
template <class Key, class Value>
inline const Value&  Heap2<Key, Value>::minItem()  const
{
  return data[1].value;
}

template <class Key, class Value>
inline const Key&  Heap2<Key, Value>::minKey()  const
{
  return data[1].key;
}
...
template <class Key, class Value>
inline void Heap2<Key, Value>::popMin() 
{
    deleteMinBasic();
}
