...
//#include "/Users/chrisn/Programming/workspace/diplomatiki/pareto-approximator/experiments/vs_namoa_star/experiments_vs_namoa_star_utility.h"
//#include "/home/nitsas/Programming/workspace/diplomatiki/pareto-approximator/experiments/vs_namoa_star/experiments_vs_namoa_star_utility.h"
...
//            u->heuristicList[0] = greatCircle( double(u->x)/100000, double(u->y)/100000, double(t->x)/100000, double(t->y)/100000);
            u->heuristicList[0] = experiments_vs_namoa_star::greatCircleUnderestimate( double(u->x)/100000, double(u->y)/100000, double(t->x)/100000, double(t->y)/100000);
