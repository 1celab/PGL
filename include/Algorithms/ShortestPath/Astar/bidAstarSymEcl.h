#ifndef BIDASTARSYMECL_H
#define BIDASTARSYMECL_H
...
class BidAstarSymEcl
{
 ...
 public:
     ...
     */
    BidAstarSymEcl( GraphType& graph, unsigned int* timestamp) : G(graph), m_timestamp(timestamp)
    {
