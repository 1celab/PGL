#ifndef TIME_EXPANDED_MULTI_DIJKSTRA_H
#define TIME_EXPANDED_MULTI_DIJKSTRA_H
...
class TspMultiDijkstra
{
 ...
 public:
     ...
     */
    TspMultiDijkstra( GraphType& graph, StationContainer& netStations, VehicleContainer& vehicleContainer, TTL *timestamp) 
    : G(graph), stations(netStations), vehicles(vehicleContainer), m_timestamp(timestamp)
    {
