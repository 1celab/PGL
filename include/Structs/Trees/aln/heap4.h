...
class Heap4 {
  ...
  struct KNElement {DataKey key; DataValue value;};
...
template <class Key, class Value>
inline void Heap4<Key, Value>::clear()
{
  size = 0;
  finalLayerSize = 1;
  finalLayerDist = 0; 
...
template <class Key, class Value>
inline void Heap4<Key, Value>::reserve(std::size_t)
{
   ;
}

template <class Key, class Value>
inline bool Heap4<Key, Value>::empty() const
{
   return ( size == 0);
}
...
template <class Key, class Value>
inline const Value&  Heap4<Key, Value>::minItem()  const
{
  return data[1].value;
}

template <class Key, class Value>
inline const Key&  Heap4<Key, Value>::minKey()  const
{
  return data[1].key;
}
...
template <class Key, class Value>
inline void Heap4<Key, Value>::popMin() 
{
    deleteMinBasic();
}
...
deleteMinBasic()
{
  ...
  data[sz+1].key = getSupremum();
  data[sz+2].key = getSupremum();
